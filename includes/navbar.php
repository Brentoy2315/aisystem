  ...
  <nav class="navbar navbar-static-top">
    <div class="container">
      <div class="navbar-header">
        <a href="https://web.facebook.com/scoutbrent" class="navbar-brand"><b>Airline</b>Inventory</a>
        ...
        <ul class="nav navbar-nav">
          <?php
            if(isset($_SESSION['student'])){
              ...
              ";
              echo "
                <li><a href='admin/index.php' data-toggle='modal'><i class='fa fa-user-secret'></i> ADMIN</a></li>
              ";
            } 
          ?>
        </ul>
